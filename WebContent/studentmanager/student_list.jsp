	...
	<c:param name="content">
		<section class=mp-4>
			...
			<div class="my-2 text-end px-4">
				<a href="../scoremanager.main/StudentCreate.action">新規登録</a>
			</div>
			<form method="get">
				<div class="row border mx-3 mb-3 py-2 aligin-items-center rounded" id ="filter">
					...
					<div class="col-4">
						...
						<select class="form-select" id="student-f1-select" name="f2">
							<option value="0">--------</option>
					...
					<table class="table table-hover">
						...
						<c:forEach var="student" items="${students}">
							<tr>
								...
								<td><a href="../scoremanager.main/StudentUpdate.action?no=${student.no}">変更</a></td>
